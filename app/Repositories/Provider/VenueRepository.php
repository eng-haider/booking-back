...
class VenueRepository
{
    ...
    public function getAllByProvider(int $providerId, array $params = []): LengthAwarePaginator
    {
        ...
        return QueryBuilder::for(Venue::class)
            ...
            ->allowedIncludes(['amenities', 'photos', 'bookings', 'bookings.customer', 'owner', 'provider', 'category', 'reviews', 'reviews.customer', 'reviews.user', 'schedules'])
    ...
    public function updateSchedules(Venue $venue, array $schedules): void
    {
        ...
        foreach ($schedules as $scheduleData) {
            ...
            $mappedData = [
                ...
                'is_closed' => !$scheduleData['is_available'],
                'open_time' => $scheduleData['start_time'],
